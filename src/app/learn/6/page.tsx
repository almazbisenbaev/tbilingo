export default function Page() {
  ...
  return (
    <div className="h-screen flex items-center justify-center text-center">
      <div>Moved to <br /><a target="_blank" href="https://tbilingo-app.vercel.app/"><b>tbilingo-app.vercel.app</b></a></div>
    </div>
  )
...
//           {learnedCount} / {total} pronouns learned
//         </div>
//       </div>
//     </div>
//   );
...
// export default function LevelPronounsPage() {
...
//           setCourseInfo({
//             title: data.title || 'Pronouns',
//             description: data.description || 'Learn Georgian pronouns',
//             icon: data.icon || '/images/icon-phrases.svg'
//           });
//         } else {
//            setCourseInfo({
//             title: 'Pronouns',
//             description: 'Learn Georgian pronouns',
...
//       }}>
//         <p>Error loading pronouns: {wordsError}</p>
...
//         flexDirection: 'column'
//       }}>
//         <p>No pronouns data found. Please check the manual data entry guide.</p>
...
//         }, { merge: true });
//       } catch (e) {
//         console.error('❌ Error saving learned pronoun:', e);
//       }
//     })();
//   };
...
//         <LevelNavbar
//           title={courseInfo?.title || 'Pronouns'}
//           backHref="/learn"
//         />

//         {courseInfo && (
//           <PronounsProgressCard
//             course={courseInfo}
//             total={words.length}
...
//                 <p className="text-green-600">You've learned all pronouns</p>
//               </div>
//             ) : (
...
//                   <p className='mb-2'>Session progress: <b>{wordsToReview.filter(word => learnedWords.includes(word.id)).length}</b> pronouns mastered</p>
